...
const aiFeatureImage = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="400" viewBox="0 0 800 400"><defs><linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#3b82f6;stop-opacity:1" /><stop offset="100%" style="stop-color:#6366f1;stop-opacity:1" /></linearGradient></defs><rect width="800" height="400" fill="url(#grad1)"/><text x="400" y="200" font-family="Arial" font-size="36" text-anchor="middle" fill="white">AI-Powered Analysis</text><circle cx="200" cy="200" r="50" fill="white" fill-opacity="0.2"/><circle cx="600" cy="200" r="80" fill="white" fill-opacity="0.2"/><path d="M300,300 Q400,100 500,300" stroke="white" stroke-width="6" fill="none"/></svg>`;

const streamingDataImage = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="400" viewBox="0 0 800 400"><defs><linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#059669;stop-opacity:1" /><stop offset="100%" style="stop-color:#10b981;stop-opacity:1" /></linearGradient></defs><rect width="800" height="400" fill="url(#grad2)"/><text x="400" y="200" font-family="Arial" font-size="36" text-anchor="middle" fill="white">Streaming Data</text><path d="M100,250 L200,250 L250,200 L350,300 L450,150 L550,250 L650,200 L700,250" stroke="white" stroke-width="8" fill="none"/><circle cx="100" cy="250" r="8" fill="white"/><circle cx="200" cy="250" r="8" fill="white"/><circle cx="250" cy="200" r="8" fill="white"/><circle cx="350" cy="300" r="8" fill="white"/><circle cx="450" cy="150" r="8" fill="white"/><circle cx="550" cy="250" r="8" fill="white"/><circle cx="650" cy="200" r="8" fill="white"/><circle cx="700" cy="250" r="8" fill="white"/></svg>`;

const cloudSolutionImage = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="400" viewBox="0 0 800 400"><defs><linearGradient id="grad3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#0369a1;stop-opacity:1" /><stop offset="100%" style="stop-color:#0ea5e9;stop-opacity:1" /></linearGradient></defs><rect width="800" height="400" fill="url(#grad3)"/><text x="400" y="200" font-family="Arial" font-size="36" text-anchor="middle" fill="white">AWS Cloud Solution</text><path d="M250,250 Q325,175 400,250 T550,250" stroke="white" stroke-width="10" fill="white" fill-opacity="0.2"/><circle cx="250" cy="250" r="30" fill="white" fill-opacity="0.3"/><circle cx="400" cy="250" r="30" fill="white" fill-opacity="0.3"/><circle cx="550" cy="250" r="30" fill="white" fill-opacity="0.3"/></svg>`;

const hrPromptToolImage = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="400" viewBox="0 0 800 400"><defs><linearGradient id="grad4" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#be185d;stop-opacity:1" /><stop offset="100%" style="stop-color:#ec4899;stop-opacity:1" /></linearGradient></defs><rect width="800" height="400" fill="url(#grad4)"/><text x="400" y="200" font-family="Arial" font-size="36" text-anchor="middle" fill="white">HR Prompt Tool</text><circle cx="200" cy="200" r="60" fill="white" fill-opacity="0.2"/><circle cx="200" cy="200" r="40" fill="white" fill-opacity="0.2"/><circle cx="200" cy="200" r="20" fill="white" fill-opacity="0.2"/><rect x="400" y="150" width="200" height="20" rx="10" fill="white" fill-opacity="0.3"/><rect x="400" y="190" width="200" height="20" rx="10" fill="white" fill-opacity="0.3"/><rect x="400" y="230" width="200" height="20" rx="10" fill="white" fill-opacity="0.3"/></svg>`;

const awsSecurityImage = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="400" viewBox="0 0 800 400"><defs><linearGradient id="grad5" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#991b1b;stop-opacity:1" /><stop offset="100%" style="stop-color:#ef4444;stop-opacity:1" /></linearGradient></defs><rect width="800" height="400" fill="url(#grad5)"/><text x="400" y="200" font-family="Arial" font-size="36" text-anchor="middle" fill="white">AWS Security</text><path d="M350,200 L450,200 L450,250 L400,300 L350,250 Z" fill="white" fill-opacity="0.3"/><circle cx="400" cy="175" r="10" fill="white"/></svg>`;
